...
namespace RecognitionV3
{
    public partial class Training_Form : Form
    {
        ...
        public Training_Form(FormMain _Parent)
        {
            InitializeComponent();
            Parent = _Parent;
            string Face = "haarcascade_frontalface_default.xml";
        ...
        void FrameGrabber(object sender, EventArgs e)
        {
            ...
            {
                //Face Detector
                RecognitionV3.DetectFace.Detect(currentFrame, "haarcascade_frontalface_default.xml", faces, out detectionTime);
                ...
                {
                    result = currentFrame.Copy(face).Convert<Gray, byte>().Resize(100, 100, Emgu.CV.CvEnum.INTER.CV_INTER_CUBIC);
